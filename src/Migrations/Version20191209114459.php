 ...
 */
final class Version20191209114459 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE tlt_answer (id INT NOT NULL, text VARCHAR(255) NOT NULL, correction INT NOT NULL, PRIMARY KEY(id))');
